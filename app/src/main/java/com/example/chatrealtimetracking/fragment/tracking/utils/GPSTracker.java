package com.example.chatrealtimetracking.fragment.tracking.utils;
...
public class GPSTracker extends Service implements LocationListener {
    ...
    private static final long MIN_TIME = 1000 * 1 * 1; // 1 minute
            ...
            if (!isGPSEnabled && !isNetworkEnabled) {
                ...
                if (isNetworkEnabled) {
                    if (checkPermission(context)) {
                        ...
                        MyFunction.toast(context, "Permission for GPS not valid");
                    }
                }
